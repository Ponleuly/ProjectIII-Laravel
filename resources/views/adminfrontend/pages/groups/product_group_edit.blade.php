        ...
        <form  action="{{url('/admin/product-group-edit/'.$group->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 my-3 mb-md-0">
                    ...
                    <h4 class="mb-2 text-black">Edit product group</h4>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    <div class="col-md-12">
                                        ...
                                        <input group="text" class="form-control rounded-0 fw-500 mb-2 text-capitalize" id="group_namee" name="group_name" placeholder="group name..." value="{{$group->group_name}}">

                                        <div class="d-flex mt-4">
                                            <a class="btn btn-outline-danger rounded-0 mt-3" href="{{url('/admin/product-group-list')}}" role="button">Back to list</a>
                                            <button class="btn btn-primary rounded-0 ms-auto mt-3" group="submit">Update product group</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
