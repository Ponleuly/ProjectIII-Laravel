            ...
            <div class="row justify-content-center">
                <div class="col-md-12 my-3 mb-md-0">
                    ...
                    <div class="p-lg-5 border bg-white" id="printableArea">
                        ...
                        <div class="row d-flex align-items-baseline">
                            <div class="col-xl-9">
                                <h2 class="pt-0 text-black fw-bold text-danger mb-1">15Steps</h2>
                            </div>
                            <div class="col-xl-3">
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                ...
                                <p class=" fs-5 mb-1 text-muted">{{$orderDetail->payment_method}}</p>
                            </div>
                            <div class="col-xl-3">
                                <ul class="list-unstyled">
                                    <li class="text-muted ">
                                    ...
                                    <li class="text-muted ">
                                        <p class="text-muted fs-5 fw-bold mb-1">Total amount :
